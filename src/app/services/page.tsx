      ...
      <section className="px-6 pt-48 pb-24 sm:px-12 lg:px-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Link
              href="/contact"
              className="group relative flex flex-col items-start justify-center overflow-hidden rounded-2xl bg-linear-to-br from-pink-500 to-orange-400 p-8 text-white transition-transform hover:scale-[1.01]"
            >
